        ...
        <div class="basicElement">
          ...
          <div>
            @if ($deceased->dob_month || $deceased->dob_day || $deceased->dob_year)
              {{ $all_months[intval($deceased->dob_month) - 1] ?? "___" }} {{ intval($deceased->dob_day) != null ? intval($deceased->dob_day) : "__" }}{{ $dob_daySuffix ?? '' }}, {{ $deceased->dob_year ?? "____" }}
        ...
        <div class="basicElement">
          ...
          <div>
            @if ($deceased->dod_month || $deceased->dod_day || $deceased->dod_year)
              {{ $all_months[intval($deceased->dod_month) - 1] ?? "___" }} {{ intval($deceased->dod_day) != null ? intval($deceased->dod_day) : "__" }}{{ $dod_daySuffix ?? '' }}, {{ $deceased->dod_year ?? "____" }}
